 ...
 * @author Jesus
 */
public class LServidor extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Lanssenger.initServer();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Lanssenger.servidor.enviarMSG(this.TXTmsgEnviar.getText());
        this.TXTmsgEnviar.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LServidor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
